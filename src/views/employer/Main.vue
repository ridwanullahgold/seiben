    ...
    <div class="container">
      <div class="row mb-7">
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
          ...
          <a
            href="#"
            class="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
          >
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
          ...
          >
            <div
              class="text-orange bg-orange-opacity-1 circle-56 font-size-6 mr-7"
            >
            ...
            <div class="">
              <h5
                class="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1"
              >
                <span class="counter">16.5</span>K
              </h5>
              <p class="font-size-4 font-weight-normal text-gray mb-0">
                Jobs View
              </p>
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
          ...
          >
            <div
              class="text-egg-blue bg-egg-blue-opacity-1 circle-56 font-size-6 mr-7"
            >
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  <th
                    scope="col"
                    class="pl-0  border-0 font-size-4 font-weight-normal"
                  >
                    Name
                  </th>
                  <th
                    scope="col"
                    class="border-0 font-size-4 font-weight-normal"
                  >
                    Applied as
                  </th>
                  <th
              ...
              <tbody>
                <tr class="border border-color-2">
                  ...
                  <td class="table-y-middle py-7 min-width-px-235 pr-0">
                    <h3
                      class="font-size-4 font-weight-normal text-black-2 mb-0"
                    >
                  ...
                  <td class="table-y-middle py-7 min-width-px-170 pr-0">
                    <div class="">
                      <a
                        href="javacript:"
                        class="font-size-3 font-weight-bold text-black-2 text-uppercase"
                        data-toggle="modal"
                  ...
                  <td class="table-y-middle py-7 min-width-px-110 pr-0">
                    <div class="">
                      <a
                        href="contact.html"
                        class="font-size-3 font-weight-bold text-green text-uppercase"
                        >Contact</a
                      >
                    </div>
                  </td>
